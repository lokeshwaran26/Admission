...
function Courses() {
  return (
    <>
      ...
      <div className="min-h-screen  bg-gradient-to-tr bg-gray-100 flex justify-center items-center ">
        <div className="px-21 ml-96 mb-24 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            {/* <h3 className="mb-3 text-xl font-bold text-indigo-600">BE</h3> */}
            <div className="relative">
              <img className="w-full rounded-xl" src={BCA_IMG} alt="Colors" />
            </div>
            <h1 className="mt-4 text-gray-800 text-2xl font-bold cursor-pointer">Bachelor of Engineering</h1>
            <div className="my-9">
              ...
              <Link to="BE">
                <button className="mt-4 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg">Courses</button>
              </Link>
            </div>
          </div>
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
